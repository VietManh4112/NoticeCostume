    ...
    <div>
        <div class="main">
            ...
            <div class="content">
                ...
                <Modal v-if="hideModalBuy" type="modal-buy" @hide-modal__buy="handleHideModalBuy" :hideModalBuy="hideModalBuy"></Modal>
                <Modal v-if="hideModalContinue" type="modal-continue" @hide-modal__continue="handleHideModalContinue" :hideModalContinue="hideModalContinue"></Modal>
                    ...
                    <div class="box-comment">
                        <div class="box-comment__question">
                            ...
                            <div class="comment-button">
                                ...
                                <button v-if="userIdToken === comment.userId || sub.includes('admin')" title="Xóa" style="color: red; width: 30px; height: 30px;"
